...
export interface StagedFinalizeBlockEventProtoMsg {
  typeUrl: "/dydxprotocol.clob.StagedFinalizeBlockEvent";
  value: Uint8Array;
}
/**
 * StagedFinalizeBlockEvent is an event staged during `FinalizeBlock`.
 ...
 * @see proto type: dydxprotocol.clob.StagedFinalizeBlockEvent
 */
...
export interface StagedFinalizeBlockEventAminoMsg {
  type: "/dydxprotocol.clob.StagedFinalizeBlockEvent";
