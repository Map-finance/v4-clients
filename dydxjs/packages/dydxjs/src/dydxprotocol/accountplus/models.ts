...
export interface AccountAuthenticatorProtoMsg {
  typeUrl: "/dydxprotocol.accountplus.AccountAuthenticator";
  value: Uint8Array;
}
/**
 * AccountAuthenticator represents a foundational model for all authenticators.
 ...
 * @see proto type: dydxprotocol.accountplus.AccountAuthenticator
 */
...
export interface AccountAuthenticatorAminoMsg {
  type: "/dydxprotocol.accountplus.AccountAuthenticator";
