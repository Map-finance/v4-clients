...
export class MsgClientImpl implements Msg {
  ...
  createBridgeTransfer(request: MsgCreateBridgeTransfer): Promise<MsgCreateBridgeTransferResponse> {
    ...
    const promise = this.rpc.request("h2x.sending.Msg", "CreateBridgeTransfer", data);
  ...
  createTransfer(request: MsgCreateTransfer): Promise<MsgCreateTransferResponse> {
    ...
    const promise = this.rpc.request("h2x.sending.Msg", "CreateTransfer", data);
  ...
  depositToSubaccount(request: MsgDepositToSubaccount): Promise<MsgDepositToSubaccountResponse> {
    ...
    const promise = this.rpc.request("h2x.sending.Msg", "DepositToSubaccount", data);
  ...
  withdrawFromSubaccount(request: MsgWithdrawFromSubaccount): Promise<MsgWithdrawFromSubaccountResponse> {
    ...
    const promise = this.rpc.request("h2x.sending.Msg", "WithdrawFromSubaccount", data);
