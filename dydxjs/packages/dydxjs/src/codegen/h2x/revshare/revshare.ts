...
export interface MarketMapperRevShareDetailsProtoMsg {
  typeUrl: "/h2x.revshare.MarketMapperRevShareDetails";
  value: Uint8Array;
}
/**
 * MarketMapperRevShareDetails specifies any details associated with the market
 ...
 * @see proto type: h2x.revshare.MarketMapperRevShareDetails
 */
...
export interface MarketMapperRevShareDetailsAminoMsg {
  type: "/h2x.revshare.MarketMapperRevShareDetails";
...
export interface UnconditionalRevShareConfigProtoMsg {
  typeUrl: "/h2x.revshare.UnconditionalRevShareConfig";
  value: Uint8Array;
}
/**
 * UnconditionalRevShareConfig stores recipients that
 ...
 * @package h2x.revshare
 * @see proto type: h2x.revshare.UnconditionalRevShareConfig
 */
...
export interface UnconditionalRevShareConfigAminoMsg {
  type: "/h2x.revshare.UnconditionalRevShareConfig";
...
export interface UnconditionalRevShareConfig_RecipientConfigProtoMsg {
  typeUrl: "/h2x.revshare.RecipientConfig";
  value: Uint8Array;
}
/**
 * Describes the config of a recipient
 ...
 * @package h2x.revshare
 * @see proto type: h2x.revshare.UnconditionalRevShareConfig_RecipientConfig
 */
...
export interface UnconditionalRevShareConfig_RecipientConfigAminoMsg {
  type: "/h2x.revshare.RecipientConfig";
...
export interface OrderRouterRevShareProtoMsg {
  typeUrl: "/h2x.revshare.OrderRouterRevShare";
  value: Uint8Array;
}
/**
 * Message to set the order router revenue share
 ...
 * @package h2x.revshare
 * @see proto type: h2x.revshare.OrderRouterRevShare
 */
...
export interface OrderRouterRevShareAminoMsg {
  type: "/h2x.revshare.OrderRouterRevShare";
