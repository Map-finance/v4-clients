...
export interface AccountStateProtoMsg {
  typeUrl: "/h2x.accountplus.AccountState";
  value: Uint8Array;
}
/**
 * Account State
 ...
 * @see proto type: h2x.accountplus.AccountState
 */
...
export interface AccountStateAminoMsg {
  type: "/h2x.accountplus.AccountState";
...
export interface TimestampNonceDetailsProtoMsg {
  typeUrl: "/h2x.accountplus.TimestampNonceDetails";
  value: Uint8Array;
}
/**
 * Timestamp nonce details
 ...
 * @package h2x.accountplus
 * @see proto type: h2x.accountplus.TimestampNonceDetails
 */
...
export interface TimestampNonceDetailsAminoMsg {
  type: "/h2x.accountplus.TimestampNonceDetails";
