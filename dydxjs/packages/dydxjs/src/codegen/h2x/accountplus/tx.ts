 ...
 * @see proto type: h2x.accountplus.MsgAddAuthenticator
 */
...
export interface MsgAddAuthenticatorAminoMsg {
  type: "h2x/accountplus/add-authenticator";
...
export interface MsgAddAuthenticatorResponseProtoMsg {
  typeUrl: "/h2x.accountplus.MsgAddAuthenticatorResponse";
  value: Uint8Array;
}
/**
 * MsgAddAuthenticatorResponse defines the Msg/AddAuthenticator response type.
 ...
 * @package h2x.accountplus
 * @see proto type: h2x.accountplus.MsgAddAuthenticatorResponse
 */
export interface MsgAddAuthenticatorResponseAmino {
  success?: boolean;
}
export interface MsgAddAuthenticatorResponseAminoMsg {
  type: "/h2x.accountplus.MsgAddAuthenticatorResponse";
 ...
 * @package h2x.accountplus
 * @see proto type: h2x.accountplus.MsgRemoveAuthenticator
 */
...
export interface MsgRemoveAuthenticatorAminoMsg {
  type: "h2x/accountplus/remove-authenticator";
...
export interface MsgRemoveAuthenticatorResponseProtoMsg {
  typeUrl: "/h2x.accountplus.MsgRemoveAuthenticatorResponse";
  value: Uint8Array;
}
/**
 * MsgRemoveAuthenticatorResponse defines the Msg/RemoveAuthenticator response
 ...
 * @package h2x.accountplus
 * @see proto type: h2x.accountplus.MsgRemoveAuthenticatorResponse
 */
export interface MsgRemoveAuthenticatorResponseAmino {
  success?: boolean;
}
export interface MsgRemoveAuthenticatorResponseAminoMsg {
  type: "/h2x.accountplus.MsgRemoveAuthenticatorResponse";
 ...
 * @package h2x.accountplus
 * @see proto type: h2x.accountplus.MsgSetActiveState
 */
...
export interface MsgSetActiveStateAminoMsg {
  type: "h2x/accountplus/set-active-state";
...
export interface MsgSetActiveStateResponseProtoMsg {
  typeUrl: "/h2x.accountplus.MsgSetActiveStateResponse";
  value: Uint8Array;
}
/**
 * MsgSetActiveStateResponse defines the Msg/SetActiveState response type.
 ...
 * @package h2x.accountplus
 * @see proto type: h2x.accountplus.MsgSetActiveStateResponse
 */
export interface MsgSetActiveStateResponseAmino {}
export interface MsgSetActiveStateResponseAminoMsg {
  type: "/h2x.accountplus.MsgSetActiveStateResponse";
 ...
 * @package h2x.accountplus
 * @see proto type: h2x.accountplus.TxExtension
 */
...
export interface TxExtensionAminoMsg {
  type: "/h2x.accountplus.TxExtension";
