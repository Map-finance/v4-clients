...
export interface OrderPlaceV1ProtoMsg {
  typeUrl: "/h2x.indexer.off_chain_updates.OrderPlaceV1";
  value: Uint8Array;
}
/**
 * OrderPlace messages contain the order placed/replaced.
 * @name OrderPlaceV1Amino
 * @package h2x.indexer.off_chain_updates
 * @see proto type: h2x.indexer.off_chain_updates.OrderPlaceV1
 */
...
export interface OrderPlaceV1AminoMsg {
  type: "/h2x.indexer.off_chain_updates.OrderPlaceV1";
...
export interface OrderRemoveV1ProtoMsg {
  typeUrl: "/h2x.indexer.off_chain_updates.OrderRemoveV1";
  value: Uint8Array;
}
/**
 * OrderRemove messages contain the id of the order removed, the reason for the
 ...
 * @package h2x.indexer.off_chain_updates
 * @see proto type: h2x.indexer.off_chain_updates.OrderRemoveV1
 */
...
export interface OrderRemoveV1AminoMsg {
  type: "/h2x.indexer.off_chain_updates.OrderRemoveV1";
...
export interface OrderUpdateV1ProtoMsg {
  typeUrl: "/h2x.indexer.off_chain_updates.OrderUpdateV1";
  value: Uint8Array;
}
/**
 * OrderUpdate messages contain the id of the order being updated, and the
 ...
 * @package h2x.indexer.off_chain_updates
 * @see proto type: h2x.indexer.off_chain_updates.OrderUpdateV1
 */
...
export interface OrderUpdateV1AminoMsg {
  type: "/h2x.indexer.off_chain_updates.OrderUpdateV1";
...
export interface OrderReplaceV1ProtoMsg {
  typeUrl: "/h2x.indexer.off_chain_updates.OrderReplaceV1";
  value: Uint8Array;
}
/**
 * OrderReplace messages contain the old order ID and the replacement order.
 ...
 * @package h2x.indexer.off_chain_updates
 * @see proto type: h2x.indexer.off_chain_updates.OrderReplaceV1
 */
...
export interface OrderReplaceV1AminoMsg {
  type: "/h2x.indexer.off_chain_updates.OrderReplaceV1";
  value: OrderReplaceV1Amino;
}
/** OrderReplace messages contain the old order ID and the replacement order. */
...
export interface OffChainUpdateV1ProtoMsg {
  typeUrl: "/h2x.indexer.off_chain_updates.OffChainUpdateV1";
  value: Uint8Array;
}
/**
 * An OffChainUpdate message is the message type which will be sent on Kafka to
 ...
 * @package h2x.indexer.off_chain_updates
 * @see proto type: h2x.indexer.off_chain_updates.OffChainUpdateV1
 */
export interface OffChainUpdateV1Amino {
  ...
  order_replace?: OrderReplaceV1Amino;
}
export interface OffChainUpdateV1AminoMsg {
  type: "/h2x.indexer.off_chain_updates.OffChainUpdateV1";
...
export const OrderPlaceV1 = {
  ...
  fromAmino(object: OrderPlaceV1Amino): OrderPlaceV1 {
    ...
    if (object.time_stamp !== undefined && object.time_stamp !== null) {
      message.timeStamp = fromTimestamp(Timestamp.fromAmino(object.time_stamp));
    }
    return message;
  },
  toAmino(message: OrderPlaceV1): OrderPlaceV1Amino {
    ...
    obj.time_stamp = message.timeStamp ? Timestamp.toAmino(toTimestamp(message.timeStamp)) : undefined;
    return obj;
  },
...
export const OrderReplaceV1 = {
  typeUrl: "/h2x.indexer.off_chain_updates.OrderReplaceV1",
  encode(message: OrderReplaceV1, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): OrderReplaceV1 {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<OrderReplaceV1>): OrderReplaceV1 {
    const message = createBaseOrderReplaceV1();
  ...
  fromAmino(object: OrderReplaceV1Amino): OrderReplaceV1 {
    const message = createBaseOrderReplaceV1();
  ...
  toAmino(message: OrderReplaceV1): OrderReplaceV1Amino {
    const obj: any = {};
  ...
  fromAminoMsg(object: OrderReplaceV1AminoMsg): OrderReplaceV1 {
    return OrderReplaceV1.fromAmino(object.value);
  },
  fromProtoMsg(message: OrderReplaceV1ProtoMsg): OrderReplaceV1 {
    return OrderReplaceV1.decode(message.value);
  },
  toProto(message: OrderReplaceV1): Uint8Array {
    return OrderReplaceV1.encode(message).finish();
  },
  toProtoMsg(message: OrderReplaceV1): OrderReplaceV1ProtoMsg {
    return {
      typeUrl: "/h2x.indexer.off_chain_updates.OrderReplaceV1",
      value: OrderReplaceV1.encode(message).finish()
    };
  }
};
...
export const OffChainUpdateV1 = {
  ...
  fromAmino(object: OffChainUpdateV1Amino): OffChainUpdateV1 {
    ...
    if (object.order_replace !== undefined && object.order_replace !== null) {
      message.orderReplace = OrderReplaceV1.fromAmino(object.order_replace);
    }
    return message;
  },
  toAmino(message: OffChainUpdateV1): OffChainUpdateV1Amino {
    ...
    obj.order_replace = message.orderReplace ? OrderReplaceV1.toAmino(message.orderReplace) : undefined;
    return obj;
  },
