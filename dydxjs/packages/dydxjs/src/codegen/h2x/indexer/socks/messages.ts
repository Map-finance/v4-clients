...
export interface OrderbookMessageProtoMsg {
  typeUrl: "/h2x.indexer.socks.OrderbookMessage";
  value: Uint8Array;
}
/**
 * Message to be sent through the 'to-websockets-orderbooks` kafka topic.
 * @name OrderbookMessageAmino
 * @package h2x.indexer.socks
 * @see proto type: h2x.indexer.socks.OrderbookMessage
 */
...
export interface OrderbookMessageAminoMsg {
  type: "/h2x.indexer.socks.OrderbookMessage";
...
export interface SubaccountMessageProtoMsg {
  typeUrl: "/h2x.indexer.socks.SubaccountMessage";
  value: Uint8Array;
}
/**
 * Message to be sent through the 'to-websockets-subaccounts` kafka topic.
 ...
 * @package h2x.indexer.socks
 * @see proto type: h2x.indexer.socks.SubaccountMessage
 */
...
export interface SubaccountMessageAminoMsg {
  type: "/h2x.indexer.socks.SubaccountMessage";
...
export interface TradeMessageProtoMsg {
  typeUrl: "/h2x.indexer.socks.TradeMessage";
  value: Uint8Array;
}
/**
 * Message to be sent through the 'to-websockets-trades` kafka topic.
 ...
 * @package h2x.indexer.socks
 * @see proto type: h2x.indexer.socks.TradeMessage
 */
...
export interface TradeMessageAminoMsg {
  type: "/h2x.indexer.socks.TradeMessage";
...
export interface MarketMessageProtoMsg {
  typeUrl: "/h2x.indexer.socks.MarketMessage";
  value: Uint8Array;
}
/**
 * Message to be sent through the 'to-websockets-markets` kafka topic.
 ...
 * @package h2x.indexer.socks
 * @see proto type: h2x.indexer.socks.MarketMessage
 */
...
export interface MarketMessageAminoMsg {
  type: "/h2x.indexer.socks.MarketMessage";
...
export interface CandleMessageProtoMsg {
  typeUrl: "/h2x.indexer.socks.CandleMessage";
  value: Uint8Array;
}
/**
 * Message to be sent through the 'to-websockets-candles` kafka topic.
 ...
 * @package h2x.indexer.socks
 * @see proto type: h2x.indexer.socks.CandleMessage
 */
...
export interface CandleMessageAminoMsg {
  type: "/h2x.indexer.socks.CandleMessage";
...
export interface BlockHeightMessageProtoMsg {
  typeUrl: "/h2x.indexer.socks.BlockHeightMessage";
  value: Uint8Array;
}
/**
 * Message to be sent through the 'to-websockets-block-height` kafka topic.
 ...
 * @package h2x.indexer.socks
 * @see proto type: h2x.indexer.socks.BlockHeightMessage
 */
...
export interface BlockHeightMessageAminoMsg {
  type: "/h2x.indexer.socks.BlockHeightMessage";
  value: BlockHeightMessageAmino;
}
/** Message to be sent through the 'to-websockets-block-height` kafka topic. */
...
export const BlockHeightMessage = {
  typeUrl: "/h2x.indexer.socks.BlockHeightMessage",
  encode(message: BlockHeightMessage, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.blockHeight !== "") {
      writer.uint32(10).string(message.blockHeight);
    }
    if (message.time !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlockHeightMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: Partial<BlockHeightMessage>): BlockHeightMessage {
    const message = createBaseBlockHeightMessage();
    message.blockHeight = object.blockHeight ?? "";
  ...
  fromAmino(object: BlockHeightMessageAmino): BlockHeightMessage {
    const message = createBaseBlockHeightMessage();
    if (object.block_height !== undefined && object.block_height !== null) {
      message.blockHeight = object.block_height;
    }
  ...
  toAmino(message: BlockHeightMessage): BlockHeightMessageAmino {
    const obj: any = {};
    obj.block_height = message.blockHeight === "" ? undefined : message.blockHeight;
  ...
  fromAminoMsg(object: BlockHeightMessageAminoMsg): BlockHeightMessage {
    return BlockHeightMessage.fromAmino(object.value);
  },
  fromProtoMsg(message: BlockHeightMessageProtoMsg): BlockHeightMessage {
    return BlockHeightMessage.decode(message.value);
  },
  toProto(message: BlockHeightMessage): Uint8Array {
    return BlockHeightMessage.encode(message).finish();
  },
  toProtoMsg(message: BlockHeightMessage): BlockHeightMessageProtoMsg {
    return {
      typeUrl: "/h2x.indexer.socks.BlockHeightMessage",
      value: BlockHeightMessage.encode(message).finish()
    };
  }
};