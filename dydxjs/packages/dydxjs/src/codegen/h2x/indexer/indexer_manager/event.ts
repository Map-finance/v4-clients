...
export interface IndexerTendermintEventWrapperProtoMsg {
  typeUrl: "/h2x.indexer.indexer_manager.IndexerTendermintEventWrapper";
  value: Uint8Array;
}
/**
 * IndexerTendermintEventWrapper is a wrapper around IndexerTendermintEvent,
 ...
 * @package h2x.indexer.indexer_manager
 * @see proto type: h2x.indexer.indexer_manager.IndexerTendermintEventWrapper
 */
...
export interface IndexerTendermintEventWrapperAminoMsg {
  type: "/h2x.indexer.indexer_manager.IndexerTendermintEventWrapper";
...
export interface IndexerEventsStoreValueProtoMsg {
  typeUrl: "/h2x.indexer.indexer_manager.IndexerEventsStoreValue";
  value: Uint8Array;
}
/**
 * IndexerEventsStoreValue represents the type of the value of the
 ...
 * @package h2x.indexer.indexer_manager
 * @see proto type: h2x.indexer.indexer_manager.IndexerEventsStoreValue
 */
...
export interface IndexerEventsStoreValueAminoMsg {
  type: "/h2x.indexer.indexer_manager.IndexerEventsStoreValue";
...
export interface IndexerTendermintEventProtoMsg {
  typeUrl: "/h2x.indexer.indexer_manager.IndexerTendermintEvent";
  value: Uint8Array;
}
/**
 * IndexerTendermintEvent contains the base64 encoded event proto emitted from
 ...
 * @package h2x.indexer.indexer_manager
 * @see proto type: h2x.indexer.indexer_manager.IndexerTendermintEvent
 */
...
export interface IndexerTendermintEventAminoMsg {
  type: "/h2x.indexer.indexer_manager.IndexerTendermintEvent";
...
export interface IndexerTendermintBlockProtoMsg {
  typeUrl: "/h2x.indexer.indexer_manager.IndexerTendermintBlock";
  value: Uint8Array;
}
/**
 * IndexerTendermintBlock contains all the events for the block along with
 ...
 * @package h2x.indexer.indexer_manager
 * @see proto type: h2x.indexer.indexer_manager.IndexerTendermintBlock
 */
...
export interface IndexerTendermintBlockAminoMsg {
  type: "/h2x.indexer.indexer_manager.IndexerTendermintBlock";
