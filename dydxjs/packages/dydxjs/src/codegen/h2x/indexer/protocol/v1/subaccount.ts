...
export interface IndexerSubaccountIdProtoMsg {
  typeUrl: "/h2x.indexer.protocol.v1.IndexerSubaccountId";
  value: Uint8Array;
}
/**
 * IndexerSubaccountId defines a unique identifier for a Subaccount.
 ...
 * @see proto type: h2x.indexer.protocol.v1.IndexerSubaccountId
 */
...
export interface IndexerSubaccountIdAminoMsg {
  type: "/h2x.indexer.protocol.v1.IndexerSubaccountId";
...
export interface IndexerPerpetualPositionProtoMsg {
  typeUrl: "/h2x.indexer.protocol.v1.IndexerPerpetualPosition";
  value: Uint8Array;
}
/**
 * IndexerPerpetualPosition are an account’s positions of a `Perpetual`.
 ...
 * @package h2x.indexer.protocol.v1
 * @see proto type: h2x.indexer.protocol.v1.IndexerPerpetualPosition
 */
...
export interface IndexerPerpetualPositionAminoMsg {
  type: "/h2x.indexer.protocol.v1.IndexerPerpetualPosition";
...
export interface IndexerAssetPositionProtoMsg {
  typeUrl: "/h2x.indexer.protocol.v1.IndexerAssetPosition";
  value: Uint8Array;
}
/**
 * IndexerAssetPosition define an account’s positions of an `Asset`.
 ...
 * @package h2x.indexer.protocol.v1
 * @see proto type: h2x.indexer.protocol.v1.IndexerAssetPosition
 */
...
export interface IndexerAssetPositionAminoMsg {
  type: "/h2x.indexer.protocol.v1.IndexerAssetPosition";
