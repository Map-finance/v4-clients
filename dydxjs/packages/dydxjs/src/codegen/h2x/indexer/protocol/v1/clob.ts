...
export interface IndexerOrderIdProtoMsg {
  typeUrl: "/h2x.indexer.protocol.v1.IndexerOrderId";
  value: Uint8Array;
}
/**
 * IndexerOrderId refers to a single order belonging to a Subaccount.
 * @name IndexerOrderIdAmino
 * @package h2x.indexer.protocol.v1
 * @see proto type: h2x.indexer.protocol.v1.IndexerOrderId
 */
...
export interface IndexerOrderIdAminoMsg {
  type: "/h2x.indexer.protocol.v1.IndexerOrderId";
...
export interface IndexerOrderProtoMsg {
  typeUrl: "/h2x.indexer.protocol.v1.IndexerOrder";
  value: Uint8Array;
}
/**
 * IndexerOrderV1 represents a single order belonging to a `Subaccount`
 ...
 * @package h2x.indexer.protocol.v1
 * @see proto type: h2x.indexer.protocol.v1.IndexerOrder
 */
...
export interface IndexerOrderAminoMsg {
  type: "/h2x.indexer.protocol.v1.IndexerOrder";
...
export interface TwapParametersProtoMsg {
  typeUrl: "/h2x.indexer.protocol.v1.TwapParameters";
  value: Uint8Array;
}
/**
 * TwapParameters represents the necessary configuration for a TWAP order.
 ...
 * @package h2x.indexer.protocol.v1
 * @see proto type: h2x.indexer.protocol.v1.TwapParameters
 */
...
export interface TwapParametersAminoMsg {
  type: "/h2x.indexer.protocol.v1.TwapParameters";
...
export interface BuilderCodeParametersProtoMsg {
  typeUrl: "/h2x.indexer.protocol.v1.BuilderCodeParameters";
  value: Uint8Array;
}
/**
 * BuilderCodeParameters represents the metadata for the partner or builder of
 ...
 * @package h2x.indexer.protocol.v1
 * @see proto type: h2x.indexer.protocol.v1.BuilderCodeParameters
 */
...
export interface BuilderCodeParametersAminoMsg {
  type: "/h2x.indexer.protocol.v1.BuilderCodeParameters";
