...
export class QueryClientImpl implements Query {
  ...
  affiliateInfo(request: AffiliateInfoRequest): Promise<AffiliateInfoResponse> {
    ...
    const promise = this.rpc.request("h2x.affiliates.Query", "AffiliateInfo", data);
  ...
  referredBy(request: ReferredByRequest): Promise<ReferredByResponse> {
    ...
    const promise = this.rpc.request("h2x.affiliates.Query", "ReferredBy", data);
  ...
  allAffiliateTiers(request: AllAffiliateTiersRequest = {}): Promise<AllAffiliateTiersResponse> {
    ...
    const promise = this.rpc.request("h2x.affiliates.Query", "AllAffiliateTiers", data);
  ...
  affiliateWhitelist(request: AffiliateWhitelistRequest = {}): Promise<AffiliateWhitelistResponse> {
    ...
    const promise = this.rpc.request("h2x.affiliates.Query", "AffiliateWhitelist", data);
    return promise.then(data => AffiliateWhitelistResponse.decode(new BinaryReader(data)));
  }
  affiliateParameters(request: AffiliateParametersRequest = {}): Promise<AffiliateParametersResponse> {
    const data = AffiliateParametersRequest.encode(request).finish();
    const promise = this.rpc.request("h2x.affiliates.Query", "AffiliateParameters", data);
    return promise.then(data => AffiliateParametersResponse.decode(new BinaryReader(data)));
  }
  affiliateOverrides(request: AffiliateOverridesRequest = {}): Promise<AffiliateOverridesResponse> {
    const data = AffiliateOverridesRequest.encode(request).finish();
    const promise = this.rpc.request("h2x.affiliates.Query", "AffiliateOverrides", data);
    return promise.then(data => AffiliateOverridesResponse.decode(new BinaryReader(data)));
  }
}
