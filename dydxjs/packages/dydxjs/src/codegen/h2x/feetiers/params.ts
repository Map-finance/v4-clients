...
export interface PerpetualFeeParamsProtoMsg {
  typeUrl: "/h2x.feetiers.PerpetualFeeParams";
  value: Uint8Array;
}
/**
 * PerpetualFeeParams defines the parameters for perpetual fees.
 ...
 * @see proto type: h2x.feetiers.PerpetualFeeParams
 */
...
export interface PerpetualFeeParamsAminoMsg {
  type: "/h2x.feetiers.PerpetualFeeParams";
...
export interface PerpetualFeeTierProtoMsg {
  typeUrl: "/h2x.feetiers.PerpetualFeeTier";
  value: Uint8Array;
}
/**
 * A fee tier for perpetuals
 ...
 * @package h2x.feetiers
 * @see proto type: h2x.feetiers.PerpetualFeeTier
 */
...
export interface PerpetualFeeTierAminoMsg {
  type: "/h2x.feetiers.PerpetualFeeTier";
