 ...
 * @name NumSharesAmino
 * @package h2x.vault
 * @see proto type: h2x.vault.NumShares
 */
 ...
 * @package h2x.vault
 * @see proto type: h2x.vault.OwnerShare
 */
...
export interface OwnerShareUnlocksProtoMsg {
  typeUrl: "/h2x.vault.OwnerShareUnlocks";
  value: Uint8Array;
}
/**
 * OwnerShareUnlocks stores share unlocks for an owner.
 ...
 * @package h2x.vault
 * @see proto type: h2x.vault.OwnerShareUnlocks
 */
...
export interface OwnerShareUnlocksAminoMsg {
  type: "/h2x.vault.OwnerShareUnlocks";
 ...
 * @package h2x.vault
 * @see proto type: h2x.vault.ShareUnlock
 */
