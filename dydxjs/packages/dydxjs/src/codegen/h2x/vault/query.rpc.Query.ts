...
export class QueryClientImpl implements Query {
  ...
  params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("h2x.vault.Query", "Params", data);
    return promise.then(data => QueryParamsResponse.decode(new BinaryReader(data)));
  }
  vault(request: QueryVaultRequest): Promise<QueryVaultResponse> {
    const data = QueryVaultRequest.encode(request).finish();
    const promise = this.rpc.request("h2x.vault.Query", "Vault", data);
  ...
  allVaults(request: QueryAllVaultsRequest = {
    ...
    const promise = this.rpc.request("h2x.vault.Query", "AllVaults", data);
  ...
  megavaultTotalShares(request: QueryMegavaultTotalSharesRequest = {}): Promise<QueryMegavaultTotalSharesResponse> {
    ...
    const promise = this.rpc.request("h2x.vault.Query", "MegavaultTotalShares", data);
  ...
  megavaultOwnerShares(request: QueryMegavaultOwnerSharesRequest): Promise<QueryMegavaultOwnerSharesResponse> {
    ...
    const promise = this.rpc.request("h2x.vault.Query", "MegavaultOwnerShares", data);
  ...
  megavaultAllOwnerShares(request: QueryMegavaultAllOwnerSharesRequest = {
    ...
    const promise = this.rpc.request("h2x.vault.Query", "MegavaultAllOwnerShares", data);
    return promise.then(data => QueryMegavaultAllOwnerSharesResponse.decode(new BinaryReader(data)));
  }
  vaultParams(request: QueryVaultParamsRequest): Promise<QueryVaultParamsResponse> {
    const data = QueryVaultParamsRequest.encode(request).finish();
    const promise = this.rpc.request("h2x.vault.Query", "VaultParams", data);
    return promise.then(data => QueryVaultParamsResponse.decode(new BinaryReader(data)));
  }
  megavaultWithdrawalInfo(request: QueryMegavaultWithdrawalInfoRequest): Promise<QueryMegavaultWithdrawalInfoResponse> {
    const data = QueryMegavaultWithdrawalInfoRequest.encode(request).finish();
    const promise = this.rpc.request("h2x.vault.Query", "MegavaultWithdrawalInfo", data);
    return promise.then(data => QueryMegavaultWithdrawalInfoResponse.decode(new BinaryReader(data)));
  }
}
