...
export class MsgClientImpl implements Msg {
  ...
  depositToMegavault(request: MsgDepositToMegavault): Promise<MsgDepositToMegavaultResponse> {
    ...
    const promise = this.rpc.request("h2x.vault.Msg", "DepositToMegavault", data);
  ...
  withdrawFromMegavault(request: MsgWithdrawFromMegavault): Promise<MsgWithdrawFromMegavaultResponse> {
    ...
    const promise = this.rpc.request("h2x.vault.Msg", "WithdrawFromMegavault", data);
    return promise.then(data => MsgWithdrawFromMegavaultResponse.decode(new BinaryReader(data)));
  }
  updateDefaultQuotingParams(request: MsgUpdateDefaultQuotingParams): Promise<MsgUpdateDefaultQuotingParamsResponse> {
    const data = MsgUpdateDefaultQuotingParams.encode(request).finish();
    const promise = this.rpc.request("h2x.vault.Msg", "UpdateDefaultQuotingParams", data);
  ...
  updateOperatorParams(request: MsgUpdateOperatorParams): Promise<MsgUpdateOperatorParamsResponse> {
    ...
    const promise = this.rpc.request("h2x.vault.Msg", "UpdateOperatorParams", data);
    return promise.then(data => MsgUpdateOperatorParamsResponse.decode(new BinaryReader(data)));
  }
  setVaultParams(request: MsgSetVaultParams): Promise<MsgSetVaultParamsResponse> {
    const data = MsgSetVaultParams.encode(request).finish();
    const promise = this.rpc.request("h2x.vault.Msg", "SetVaultParams", data);
  ...
  unlockShares(request: MsgUnlockShares): Promise<MsgUnlockSharesResponse> {
    ...
    const promise = this.rpc.request("h2x.vault.Msg", "UnlockShares", data);
    return promise.then(data => MsgUnlockSharesResponse.decode(new BinaryReader(data)));
  }
  allocateToVault(request: MsgAllocateToVault): Promise<MsgAllocateToVaultResponse> {
    const data = MsgAllocateToVault.encode(request).finish();
    const promise = this.rpc.request("h2x.vault.Msg", "AllocateToVault", data);
    return promise.then(data => MsgAllocateToVaultResponse.decode(new BinaryReader(data)));
  }
  retrieveFromVault(request: MsgRetrieveFromVault): Promise<MsgRetrieveFromVaultResponse> {
    const data = MsgRetrieveFromVault.encode(request).finish();
    const promise = this.rpc.request("h2x.vault.Msg", "RetrieveFromVault", data);
    return promise.then(data => MsgRetrieveFromVaultResponse.decode(new BinaryReader(data)));
  }
}