...
export interface GenesisStateProtoMsg {
  typeUrl: "/h2x.vault.GenesisState";
  value: Uint8Array;
}
/**
 * GenesisState defines `x/vault`'s genesis state.
 ...
 * @package h2x.vault
 * @see proto type: h2x.vault.GenesisState
 */
 ...
 * @name VaultAmino
 * @package h2x.vault
 * @see proto type: h2x.vault.Vault
 */
...
export interface GenesisStateV6ProtoMsg {
  typeUrl: "/h2x.vault.GenesisStateV6";
  value: Uint8Array;
}
/**
 * GenesisStateV6 defines `x/vault`'s genesis state in v6.x.
 ...
 * @package h2x.vault
 * @see proto type: h2x.vault.GenesisStateV6
 */
 ...
 * @name VaultV6Amino
 * @package h2x.vault
 * @see proto type: h2x.vault.VaultV6
 */
