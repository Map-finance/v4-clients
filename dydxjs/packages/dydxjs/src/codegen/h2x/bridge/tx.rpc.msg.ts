...
export class MsgClientImpl implements Msg {
  ...
  acknowledgeBridges(request: MsgAcknowledgeBridges): Promise<MsgAcknowledgeBridgesResponse> {
    ...
    const promise = this.rpc.request("h2x.bridge.Msg", "AcknowledgeBridges", data);
  ...
  completeBridge(request: MsgCompleteBridge): Promise<MsgCompleteBridgeResponse> {
    ...
    const promise = this.rpc.request("h2x.bridge.Msg", "CompleteBridge", data);
  ...
  updateEventParams(request: MsgUpdateEventParams): Promise<MsgUpdateEventParamsResponse> {
    ...
    const promise = this.rpc.request("h2x.bridge.Msg", "UpdateEventParams", data);
  ...
  updateProposeParams(request: MsgUpdateProposeParams): Promise<MsgUpdateProposeParamsResponse> {
    ...
    const promise = this.rpc.request("h2x.bridge.Msg", "UpdateProposeParams", data);
  ...
  updateSafetyParams(request: MsgUpdateSafetyParams): Promise<MsgUpdateSafetyParamsResponse> {
    ...
    const promise = this.rpc.request("h2x.bridge.Msg", "UpdateSafetyParams", data);
  ...
  updateAcknowledgedEventInfo(request: MsgUpdateAcknowledgedEventInfo): Promise<MsgUpdateAcknowledgedEventInfoResponse> {
    ...
    const promise = this.rpc.request("h2x.bridge.Msg", "UpdateAcknowledgedEventInfo", data);
