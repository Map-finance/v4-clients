...
export interface EventParamsProtoMsg {
  typeUrl: "/h2x.bridge.EventParams";
  value: Uint8Array;
}
/**
 * EventParams stores parameters about which events to recognize and which
 ...
 * @package h2x.bridge
 * @see proto type: h2x.bridge.EventParams
 */
...
export interface ProposeParamsProtoMsg {
  typeUrl: "/h2x.bridge.ProposeParams";
  value: Uint8Array;
}
/**
 * ProposeParams stores parameters for proposing to the module.
 ...
 * @package h2x.bridge
 * @see proto type: h2x.bridge.ProposeParams
 */
...
export interface SafetyParamsProtoMsg {
  typeUrl: "/h2x.bridge.SafetyParams";
  value: Uint8Array;
}
/**
 * SafetyParams stores safety parameters for the module.
 ...
 * @package h2x.bridge
 * @see proto type: h2x.bridge.SafetyParams
 */
