 ...
 * @name OperationAmino
 * @package h2x.clob
 * @see proto type: h2x.clob.Operation
 */
...
export interface InternalOperationProtoMsg {
  typeUrl: "/h2x.clob.InternalOperation";
  value: Uint8Array;
}
/**
 * InternalOperation represents an internal operation in the operations to
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.InternalOperation
 */
...
export interface InternalOperationAminoMsg {
  type: "/h2x.clob.InternalOperation";
