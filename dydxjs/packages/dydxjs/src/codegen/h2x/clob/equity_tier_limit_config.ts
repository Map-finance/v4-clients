...
export interface EquityTierLimitConfigurationProtoMsg {
  typeUrl: "/h2x.clob.EquityTierLimitConfiguration";
  value: Uint8Array;
}
/**
 * Defines the set of equity tiers to limit how many open orders
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.EquityTierLimitConfiguration
 */
...
export interface EquityTierLimitConfigurationAminoMsg {
  type: "/h2x.clob.EquityTierLimitConfiguration";
...
export interface EquityTierLimitProtoMsg {
  typeUrl: "/h2x.clob.EquityTierLimit";
  value: Uint8Array;
}
/**
 * Defines an equity tier limit.
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.EquityTierLimit
 */
