 ...
 * @name MEVMatchAmino
 * @package h2x.clob
 * @see proto type: h2x.clob.MEVMatch
 */
...
export interface MEVLiquidationMatchProtoMsg {
  typeUrl: "/h2x.clob.MEVLiquidationMatch";
  value: Uint8Array;
}
/**
 * MEVLiquidationMatch represents all necessary data to calculate MEV for a
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.MEVLiquidationMatch
 */
...
export interface MEVLiquidationMatchAminoMsg {
  type: "/h2x.clob.MEVLiquidationMatch";
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.ClobMidPrice
 */
...
export interface ValidatorMevMatchesProtoMsg {
  typeUrl: "/h2x.clob.ValidatorMevMatches";
  value: Uint8Array;
}
/**
 * ValidatorMevMatches contains all matches from the validator's local
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.ValidatorMevMatches
 */
...
export interface ValidatorMevMatchesAminoMsg {
  type: "/h2x.clob.ValidatorMevMatches";
...
export interface MevNodeToNodeMetricsProtoMsg {
  typeUrl: "/h2x.clob.MevNodeToNodeMetrics";
  value: Uint8Array;
}
/**
 * MevNodeToNodeMetrics is a data structure for encapsulating all MEV node <>
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.MevNodeToNodeMetrics
 */
...
export interface MevNodeToNodeMetricsAminoMsg {
  type: "/h2x.clob.MevNodeToNodeMetrics";
