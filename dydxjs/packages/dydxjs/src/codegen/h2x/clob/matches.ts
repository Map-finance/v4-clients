 ...
 * @name ClobMatchAmino
 * @package h2x.clob
 * @see proto type: h2x.clob.ClobMatch
 */
 ...
 * @name MakerFillAmino
 * @package h2x.clob
 * @see proto type: h2x.clob.MakerFill
 */
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.MatchOrders
 */
...
export interface MatchPerpetualLiquidationProtoMsg {
  typeUrl: "/h2x.clob.MatchPerpetualLiquidation";
  value: Uint8Array;
}
/**
 * MatchPerpetualLiquidation is an injected message used for liquidating a
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.MatchPerpetualLiquidation
 */
...
export interface MatchPerpetualLiquidationAminoMsg {
  type: "/h2x.clob.MatchPerpetualLiquidation";
...
export interface MatchPerpetualDeleveragingProtoMsg {
  typeUrl: "/h2x.clob.MatchPerpetualDeleveraging";
  value: Uint8Array;
}
/**
 * MatchPerpetualDeleveraging is an injected message used for deleveraging a
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.MatchPerpetualDeleveraging
 */
...
export interface MatchPerpetualDeleveragingAminoMsg {
  type: "/h2x.clob.MatchPerpetualDeleveraging";
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.MatchPerpetualDeleveraging_Fill
 */
