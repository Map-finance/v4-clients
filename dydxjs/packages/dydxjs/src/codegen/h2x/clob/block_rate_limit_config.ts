...
export interface BlockRateLimitConfigurationProtoMsg {
  typeUrl: "/h2x.clob.BlockRateLimitConfiguration";
  value: Uint8Array;
}
/**
 * Defines the block rate limits for CLOB specific operations.
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.BlockRateLimitConfiguration
 */
...
export interface BlockRateLimitConfigurationAminoMsg {
  type: "/h2x.clob.BlockRateLimitConfiguration";
...
export interface MaxPerNBlocksRateLimitProtoMsg {
  typeUrl: "/h2x.clob.MaxPerNBlocksRateLimit";
  value: Uint8Array;
}
/**
 * Defines a rate limit over a specific number of blocks.
 ...
 * @package h2x.clob
 * @see proto type: h2x.clob.MaxPerNBlocksRateLimit
 */
...
export interface MaxPerNBlocksRateLimitAminoMsg {
  type: "/h2x.clob.MaxPerNBlocksRateLimit";
