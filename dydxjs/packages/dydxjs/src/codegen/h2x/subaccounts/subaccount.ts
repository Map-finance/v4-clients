...
export interface SubaccountIdProtoMsg {
  typeUrl: "/h2x.subaccounts.SubaccountId";
  value: Uint8Array;
}
/**
 * SubaccountId defines a unique identifier for a Subaccount.
 ...
 * @see proto type: h2x.subaccounts.SubaccountId
 */
...
export interface SubaccountIdAminoMsg {
  type: "/h2x.subaccounts.SubaccountId";
...
export interface SubaccountProtoMsg {
  typeUrl: "/h2x.subaccounts.Subaccount";
  value: Uint8Array;
}
/**
 * Subaccount defines a single sub-account for a given address.
 ...
 * @package h2x.subaccounts
 * @see proto type: h2x.subaccounts.Subaccount
 */
...
export interface SubaccountAminoMsg {
  type: "/h2x.subaccounts.Subaccount";
