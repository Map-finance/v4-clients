...
export interface PerpetualPositionProtoMsg {
  typeUrl: "/h2x.subaccounts.PerpetualPosition";
  value: Uint8Array;
}
/**
 * PerpetualPositions are an account’s positions of a `Perpetual`.
 * Therefore they hold any information needed to trade perpetuals.
 * @name PerpetualPositionAmino
 * @package h2x.subaccounts
 * @see proto type: h2x.subaccounts.PerpetualPosition
 */
...
export interface PerpetualPositionAminoMsg {
  type: "/h2x.subaccounts.PerpetualPosition";
...
export const PerpetualPosition = {
  ...
  fromAmino(object: PerpetualPositionAmino): PerpetualPosition {
    ...
    if (object.quote_balance !== undefined && object.quote_balance !== null) {
      message.quoteBalance = bytesFromBase64(object.quote_balance);
    }
    return message;
  },
  toAmino(message: PerpetualPosition): PerpetualPositionAmino {
    ...
    obj.quote_balance = message.quoteBalance ? base64FromBytes(message.quoteBalance) : undefined;
    return obj;
  },
