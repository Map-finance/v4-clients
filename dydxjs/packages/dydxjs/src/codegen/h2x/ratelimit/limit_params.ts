...
export interface LimitParamsProtoMsg {
  typeUrl: "/h2x.ratelimit.LimitParams";
  value: Uint8Array;
}
/**
 * LimitParams defines rate limit params on a denom.
 ...
 * @see proto type: h2x.ratelimit.LimitParams
 */
...
export interface LimitParamsAminoMsg {
  type: "/h2x.ratelimit.LimitParams";
 ...
 * @name LimiterAmino
 * @package h2x.ratelimit
 * @see proto type: h2x.ratelimit.Limiter
 */
