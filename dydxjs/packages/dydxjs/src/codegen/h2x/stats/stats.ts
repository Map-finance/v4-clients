 ...
 * @package h2x.stats
 * @see proto type: h2x.stats.BlockStats
 */
 ...
 * @package h2x.stats
 * @see proto type: h2x.stats.BlockStats_Fill
 */
...
export interface StatsMetadataProtoMsg {
  typeUrl: "/h2x.stats.StatsMetadata";
  value: Uint8Array;
}
/**
 * StatsMetadata stores metadata for the x/stats module
 ...
 * @package h2x.stats
 * @see proto type: h2x.stats.StatsMetadata
 */
 ...
 * @package h2x.stats
 * @see proto type: h2x.stats.EpochStats
 */
...
export interface EpochStats_UserWithStatsProtoMsg {
  typeUrl: "/h2x.stats.UserWithStats";
  value: Uint8Array;
}
/**
 * A user and its associated stats
 ...
 * @package h2x.stats
 * @see proto type: h2x.stats.EpochStats_UserWithStats
 */
 ...
 * @package h2x.stats
 * @see proto type: h2x.stats.GlobalStats
 */
 ...
 * @name UserStatsAmino
 * @package h2x.stats
 * @see proto type: h2x.stats.UserStats
 */
...
export interface CachedStakeAmountProtoMsg {
  typeUrl: "/h2x.stats.CachedStakeAmount";
  value: Uint8Array;
}
/**
 * CachedStakeAmount stores the last calculated total staked amount for address
 ...
 * @package h2x.stats
 * @see proto type: h2x.stats.CachedStakeAmount
 */
...
export interface CachedStakeAmountAminoMsg {
  type: "/h2x.stats.CachedStakeAmount";
