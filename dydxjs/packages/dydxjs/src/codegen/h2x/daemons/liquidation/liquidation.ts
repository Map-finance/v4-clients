...
export interface LiquidateSubaccountsRequestProtoMsg {
  typeUrl: "/h2x.daemons.liquidation.LiquidateSubaccountsRequest";
  value: Uint8Array;
}
/**
 * LiquidateSubaccountsRequest is a request message that contains a list of
 ...
 * @package h2x.daemons.liquidation
 * @see proto type: h2x.daemons.liquidation.LiquidateSubaccountsRequest
 */
...
export interface LiquidateSubaccountsRequestAminoMsg {
  type: "/h2x.daemons.liquidation.LiquidateSubaccountsRequest";
...
export interface LiquidateSubaccountsResponseProtoMsg {
  typeUrl: "/h2x.daemons.liquidation.LiquidateSubaccountsResponse";
  value: Uint8Array;
}
/**
 * LiquidateSubaccountsResponse is a response message for
 ...
 * @package h2x.daemons.liquidation
 * @see proto type: h2x.daemons.liquidation.LiquidateSubaccountsResponse
 */
export interface LiquidateSubaccountsResponseAmino {}
export interface LiquidateSubaccountsResponseAminoMsg {
  type: "/h2x.daemons.liquidation.LiquidateSubaccountsResponse";
