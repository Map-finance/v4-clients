...
export interface UpdateMarketPricesRequestProtoMsg {
  typeUrl: "/h2x.daemons.pricefeed.UpdateMarketPricesRequest";
  value: Uint8Array;
}
/**
 * UpdateMarketPriceRequest is a request message updating market prices.
 * @name UpdateMarketPricesRequestAmino
 * @package h2x.daemons.pricefeed
 * @see proto type: h2x.daemons.pricefeed.UpdateMarketPricesRequest
 */
...
export interface UpdateMarketPricesRequestAminoMsg {
  type: "/h2x.daemons.pricefeed.UpdateMarketPricesRequest";
...
export interface UpdateMarketPricesResponseProtoMsg {
  typeUrl: "/h2x.daemons.pricefeed.UpdateMarketPricesResponse";
  value: Uint8Array;
}
/**
 * UpdateMarketPricesResponse is a response message for updating market prices.
 ...
 * @package h2x.daemons.pricefeed
 * @see proto type: h2x.daemons.pricefeed.UpdateMarketPricesResponse
 */
export interface UpdateMarketPricesResponseAmino {}
export interface UpdateMarketPricesResponseAminoMsg {
  type: "/h2x.daemons.pricefeed.UpdateMarketPricesResponse";
...
export interface ExchangePriceProtoMsg {
  typeUrl: "/h2x.daemons.pricefeed.ExchangePrice";
  value: Uint8Array;
}
/**
 * ExchangePrice represents a specific exchange's market price
 ...
 * @package h2x.daemons.pricefeed
 * @see proto type: h2x.daemons.pricefeed.ExchangePrice
 */
...
export interface ExchangePriceAminoMsg {
  type: "/h2x.daemons.pricefeed.ExchangePrice";
...
export interface MarketPriceUpdateProtoMsg {
  typeUrl: "/h2x.daemons.pricefeed.MarketPriceUpdate";
  value: Uint8Array;
}
/**
 * MarketPriceUpdate represents an update to a single market
 ...
 * @package h2x.daemons.pricefeed
 * @see proto type: h2x.daemons.pricefeed.MarketPriceUpdate
 */
...
export interface MarketPriceUpdateAminoMsg {
  type: "/h2x.daemons.pricefeed.MarketPriceUpdate";
