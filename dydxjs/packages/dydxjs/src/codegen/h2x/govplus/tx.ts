 ...
 * @package h2x.govplus
 * @see proto type: h2x.govplus.MsgSlashValidator
 */
...
export interface MsgSlashValidatorAminoMsg {
  type: "/h2x.govplus.MsgSlashValidator";
...
export interface MsgSlashValidatorResponseProtoMsg {
  typeUrl: "/h2x.govplus.MsgSlashValidatorResponse";
  value: Uint8Array;
}
/**
 * MsgSlashValidatorResponse is the Msg/SlashValidator response type.
