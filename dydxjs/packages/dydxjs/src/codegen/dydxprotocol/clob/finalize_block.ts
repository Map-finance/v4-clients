...
export interface ClobStagedFinalizeBlockEventProtoMsg {
  typeUrl: "/dydxprotocol.clob.ClobStagedFinalizeBlockEvent";
  value: Uint8Array;
}
/**
 * ClobStagedFinalizeBlockEvent defines a CLOB event staged during
 ...
 * @see proto type: dydxprotocol.clob.ClobStagedFinalizeBlockEvent
 */
...
export interface ClobStagedFinalizeBlockEventAminoMsg {
  type: "/dydxprotocol.clob.ClobStagedFinalizeBlockEvent";
