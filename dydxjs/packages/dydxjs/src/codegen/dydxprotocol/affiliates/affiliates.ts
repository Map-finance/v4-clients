...
export interface AffiliateWhitelistProtoMsg {
  typeUrl: "/dydxprotocol.affiliates.AffiliateWhitelist";
  value: Uint8Array;
}
/**
 * AffiliateWhitelist specifies the whitelisted affiliates.
 ...
 * @package dydxprotocol.affiliates
 * @see proto type: dydxprotocol.affiliates.AffiliateWhitelist
 */
...
export interface AffiliateWhitelistAminoMsg {
  type: "/dydxprotocol.affiliates.AffiliateWhitelist";
 ...
 * @package dydxprotocol.affiliates
 * @see proto type: dydxprotocol.affiliates.AffiliateWhitelist_Tier
 */
...
export interface AffiliateParametersProtoMsg {
  typeUrl: "/dydxprotocol.affiliates.AffiliateParameters";
  value: Uint8Array;
}
/**
 * AffiliateParameters defines the parameters for the affiliate program.
 ...
 * @package dydxprotocol.affiliates
 * @see proto type: dydxprotocol.affiliates.AffiliateParameters
 */
...
export interface AffiliateParametersAminoMsg {
  type: "/dydxprotocol.affiliates.AffiliateParameters";
...
export interface AffiliateOverridesProtoMsg {
  typeUrl: "/dydxprotocol.affiliates.AffiliateOverrides";
  value: Uint8Array;
}
/**
 * AffiliateOverrides defines the affiliate whitelist.
 ...
 * @package dydxprotocol.affiliates
 * @see proto type: dydxprotocol.affiliates.AffiliateOverrides
 */
...
export interface AffiliateOverridesAminoMsg {
  type: "/dydxprotocol.affiliates.AffiliateOverrides";
