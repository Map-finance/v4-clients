 ...
 * @see proto type: dydxprotocol.accountplus.MsgAddAuthenticator
 */
...
export interface MsgAddAuthenticatorAminoMsg {
  type: "dydxprotocol/accountplus/add-authenticator";
...
export interface MsgAddAuthenticatorResponseProtoMsg {
  typeUrl: "/dydxprotocol.accountplus.MsgAddAuthenticatorResponse";
  value: Uint8Array;
}
/**
 * MsgAddAuthenticatorResponse defines the Msg/AddAuthenticator response type.
 ...
 * @package dydxprotocol.accountplus
 * @see proto type: dydxprotocol.accountplus.MsgAddAuthenticatorResponse
 */
export interface MsgAddAuthenticatorResponseAmino {
  success?: boolean;
}
export interface MsgAddAuthenticatorResponseAminoMsg {
  type: "/dydxprotocol.accountplus.MsgAddAuthenticatorResponse";
 ...
 * @package dydxprotocol.accountplus
 * @see proto type: dydxprotocol.accountplus.MsgRemoveAuthenticator
 */
...
export interface MsgRemoveAuthenticatorAminoMsg {
  type: "dydxprotocol/accountplus/remove-authenticator";
...
export interface MsgRemoveAuthenticatorResponseProtoMsg {
  typeUrl: "/dydxprotocol.accountplus.MsgRemoveAuthenticatorResponse";
  value: Uint8Array;
}
/**
 * MsgRemoveAuthenticatorResponse defines the Msg/RemoveAuthenticator response
 ...
 * @package dydxprotocol.accountplus
 * @see proto type: dydxprotocol.accountplus.MsgRemoveAuthenticatorResponse
 */
export interface MsgRemoveAuthenticatorResponseAmino {
  success?: boolean;
}
export interface MsgRemoveAuthenticatorResponseAminoMsg {
  type: "/dydxprotocol.accountplus.MsgRemoveAuthenticatorResponse";
 ...
 * @package dydxprotocol.accountplus
 * @see proto type: dydxprotocol.accountplus.MsgSetActiveState
 */
...
export interface MsgSetActiveStateAminoMsg {
  type: "dydxprotocol/accountplus/set-active-state";
...
export interface MsgSetActiveStateResponseProtoMsg {
  typeUrl: "/dydxprotocol.accountplus.MsgSetActiveStateResponse";
  value: Uint8Array;
}
/**
 * MsgSetActiveStateResponse defines the Msg/SetActiveState response type.
 ...
 * @package dydxprotocol.accountplus
 * @see proto type: dydxprotocol.accountplus.MsgSetActiveStateResponse
 */
export interface MsgSetActiveStateResponseAmino {}
export interface MsgSetActiveStateResponseAminoMsg {
  type: "/dydxprotocol.accountplus.MsgSetActiveStateResponse";
 ...
 * @package dydxprotocol.accountplus
 * @see proto type: dydxprotocol.accountplus.TxExtension
 */
...
export interface TxExtensionAminoMsg {
  type: "/dydxprotocol.accountplus.TxExtension";
